/* robosapien_wifi_cmd: Sends to the Robosapien the commands received via WiFi
 * Requires:
...
#define ssid "..." // Insert WiFi settings here
#define pass "..." // Insert WiFi settings here
